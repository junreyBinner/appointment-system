<template>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="sm:flex sm:items-center mb-8">
        <div class="sm:flex-auto">
          ...
          <p class="mt-2 text-sm text-gray-700">
            Manage all services available for booking. Customers can book appointments for these services.
          </p>
        </div>
      ...
      <!-- Services Table -->
      <div class="bg-white shadow-sm ring-1 ring-gray-300 sm:rounded-lg">
          ...
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr v-for="service in services" :key="service.id" class="hover:bg-gray-50">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <div class="text-gray-500 line-clamp-1">{{ service.description || 'No description' }}</div>
                    </div>
                  </div>
                </td>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                  <span v-if="service.price" class="font-medium text-gray-900">${{ service.price }}</span>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                  <div class="flex items-center">
                    ...
                    {{ service.appointments_count || 0 }} bookings
                  </div>
                </td>
                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                  <div class="flex items-center justify-end space-x-3">
                    ...
                    <button 
                      ...
                      :class="service.is_active ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900'"
                      class="focus:outline-none"
                    >
                      <PowerIcon v-if="service.is_active" class="h-4 w-4" />
                      <CheckCircleIcon v-else class="h-4 w-4" />
                      <span class="sr-only">{{ service.is_active ? 'Deactivate' : 'Activate' }}</span>
                    </button>
                    <button 
        ...
        <div v-if="services.length === 0" class="text-center py-12">
          ...
          <h3 class="mt-2 text-sm font-semibold text-gray-900">No services</h3>
