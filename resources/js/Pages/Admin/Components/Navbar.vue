            ...
            <div class="flex items-center lg:order-2">
                ...
                >
                    ...
                    <button
                        ...
                        class="flex w-full py-3 px-4 border-b text-left hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600"
                    >
                        <!-- existing content -->
                ...
                >
                    ...
                    >
                        No function yet. Maybe next update.
                    </div>
                </div>
                <button
                    type="button"
                ...
                >
                    ...
                    <div
                        class="w-8 h-8 flex items-center justify-center rounded-full bg-indigo-600 text-white font-bold text-sm"
                    >
                        AQ
                    </div>
                </button>
                ...
                >
                    <div class="py-3 px-4 border-b bg-white dark:bg-gray-700">
                        <span
